    ...
    return [
      {
        ...
        main: [
          '01 Lorem ipsum dolor sit amet, consectetur adipisicing elit deleniti esse aliquam soluta, totam tenetur odit saepe vel quasi est?',
          '02 Lorem ipsum dolor sit amet, consectetur adipisicing elit deleniti esse aliquam soluta, totam tenetur odit saepe vel quasi est?'
        ]
      },
      {
        id : '02',
      ...
      },
      {
        ...
        main: [
          'No momento aceitamos Paypal, Cartões de Crédito incluindo Visa e Mastercard, Cartões de Débito e Boleto Bancário.'
        ]
      },
      {
        id : '04',
      ...
      },
      {
        ...
        main: [
          'Você receberá uma confirmação por e-mail logo após seu pedido ter sido aprovado. Por favor, aguarde até 2 (dois) dias úteis para o processamento de pedidos. Não hesite em contatar-nos diretamente com quaisquer dúvidas através do formulário de contato ou por e-mail (info@nayp.co).'
        ]
      },
      {
        id : '06',
        ...
        main: [
          'Você pode verificar essa informação clicando em “Status do Pedido”, localizado no topo desta página. Por favor, aguarde até 2 (dois) dias úteis para o processamento de pedidos. Não hesite em contatar-nos diretamente com quaisquer dúvidas através do nosso formulário de contato ou por e-mail (info@nayp.co). '
        ]
      },
      {
        id : '07',
